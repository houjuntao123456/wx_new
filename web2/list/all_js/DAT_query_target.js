...
window.onload = function () {
    switch (decodeURIComponent(getQueryVariable("type"))) {
        case 'Z':
            document.getElementById("dat_title").innerHTML = '组织目标达成';
            DAT_data="组织"
            break;
        case 'S':
            document.getElementById("dat_title").innerHTML = '门店目标达成';
            document.getElementById("dat_store").classList.remove("display_none");
            DAT_data = "门店"
            break;
        case 'Y':
            DAT_data = "员工"
            document.getElementById("dat_title").innerHTML = '员工目标达成';
            document.getElementById("dat_store").classList.remove("display_none");
...
function pullupRefresh() {
    setTimeout(function () {
        ...
        div.innerHTML = '<div class="mui-col-xs-12 mui-col-sm-12">' + DAT_data+'售额:8888888</div>'
