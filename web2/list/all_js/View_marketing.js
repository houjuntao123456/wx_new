    ...
    function addfangan() {
        ...
        div.innerHTML = '<div class="bode">'
            + ' <img class="imgss" id="imgs' + num + '" src="../images/add_picture.png" alt="" width="100%">'
            + '    </div>'
            + '  <br>'
            + '  <div>'
            + ' <textarea class="textArea" id="suoke' + num + '" cols="30" rows="10" name=""'
            + '     placeholder = "添加图文介绍详情(可不填)" ></textarea > '
            + ' </div > '
    ...
    mui(".mui-content").on('tap', '.imgss', function () {
