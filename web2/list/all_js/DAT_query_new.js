window.onload = function () {
    ...
    switch (decodeURIComponent(getQueryVariable("type"))) {
        case 'Z':
            document.getElementById("dat_title").innerHTML = '组织开卡新购';
            break;
        case 'S':
            document.getElementById("dat_title").innerHTML ='门店开卡新购';
            console.log('员工PK');
            document.getElementById("dat_store").classList.remove("display_none");
            
            break;
        case 'Y':
            document.getElementById("dat_title").innerHTML = '员工开卡新购';
            console.log('员工PK');
            document.getElementById("dat_store").classList.remove("display_none");
